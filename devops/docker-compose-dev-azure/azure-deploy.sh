...
resourcename="evehicleaccess"  # lower case, only
resourcegroup="evehicleaccess_rg"
...
# git clone https://github.com/apilogicserver/evehicleaccess.git
# cd evehicleaccess
...
az group create --name evehicleaccess_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group evehicleaccess_rg --sku S1 --is-linux
az container create --resource-group evehicleaccess_rg --name evehicleaccess --image apilogicserver/evehicleaccess:latest --dns-name-label evehicleaccess --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//evehicleaccess.westus.azurecontainer.io:5656'
