...
@Component({
  selector: 'Battery-home',
  templateUrl: './Battery-home.component.html',
  styleUrls: ['./Battery-home.component.scss']
})
export class BatteryHomeComponent implements AfterViewInit {
