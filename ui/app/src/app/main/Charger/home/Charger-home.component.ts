...
@Component({
  selector: 'Charger-home',
  templateUrl: './Charger-home.component.html',
  styleUrls: ['./Charger-home.component.scss']
})
export class ChargerHomeComponent implements AfterViewInit {
