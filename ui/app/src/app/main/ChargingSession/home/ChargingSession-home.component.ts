...
@Component({
  selector: 'ChargingSession-home',
  templateUrl: './ChargingSession-home.component.html',
  styleUrls: ['./ChargingSession-home.component.scss']
})
export class ChargingSessionHomeComponent implements AfterViewInit {
