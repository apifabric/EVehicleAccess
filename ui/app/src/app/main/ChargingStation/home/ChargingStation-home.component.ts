...
@Component({
  selector: 'ChargingStation-home',
  templateUrl: './ChargingStation-home.component.html',
  styleUrls: ['./ChargingStation-home.component.scss']
})
export class ChargingStationHomeComponent implements AfterViewInit {
