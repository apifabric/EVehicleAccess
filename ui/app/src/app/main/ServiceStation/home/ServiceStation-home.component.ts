...
@Component({
  selector: 'ServiceStation-home',
  templateUrl: './ServiceStation-home.component.html',
  styleUrls: ['./ServiceStation-home.component.scss']
})
export class ServiceStationHomeComponent implements AfterViewInit {
