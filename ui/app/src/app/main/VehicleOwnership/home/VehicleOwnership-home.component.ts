...
@Component({
  selector: 'VehicleOwnership-home',
  templateUrl: './VehicleOwnership-home.component.html',
  styleUrls: ['./VehicleOwnership-home.component.scss']
})
export class VehicleOwnershipHomeComponent implements AfterViewInit {
